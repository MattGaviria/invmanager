...
namespace invmanager.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "ProductId", "CategoryId", "ProductCategory", "ProductName", "ProductPrice", "Quantity", "Stock" },
                values: new object[,]
                {
                    { 1, 1, "Electronics", "HP Laptop", 799.99000000000001, 15, null },
                    { 2, 5, "Furniture", "Wooden Shelf", 1199.99, 5, null },
                    { 3, 4, "Toys", "Remote Control Race Car", 49.990000000000002, 20, null }
                });
